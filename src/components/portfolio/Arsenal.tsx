...
function SkillCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="mt-7 font-display text-2xl font-semibold tracking-tight text-ink md:text-[1.7rem]">
        {skill.title}
      </h3>
      <p
        className="mt-2.5 font-body text-[10px] font-semibold tracking-[0.3em]"
        ...
        <div className="sticky top-0 flex h-screen flex-col justify-center overflow-hidden">
          ...
          >
            ...
            <div className="flex w-[300px] shrink-0 items-center justify-center rounded-2xl border border-dashed border-ink/15 sm:w-[340px]">
              <p className="px-8 text-center font-display text-lg font-medium italic text-ink-soft">
          ...
          {/* progress hint */}
          <div className="absolute inset-x-0 bottom-16 mx-auto flex w-max items-center gap-4 font-body text-[10px] tracking-[0.35em] text-ink-soft/70">
